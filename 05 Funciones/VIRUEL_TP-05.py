...
# # Calcular las horas usando la funcion
# resultado_horas = segundos_a_horas(segundos_ingresados)

# print(f"{segundos_ingresados} segundos equivalen a {resultado_horas:.2f} horas.")
...
# print(f"El promedio de los tres números es: {prom:.2f}")
